            ...
            <Grid item xs={12} md={7}  className={classes.paper}>
                ...
                <Grid item xs={12} md={5} className={classes.paper}>
                    <Paper elevation={0} className={classes.sidebarAboutBox}>
                        ...
                        <Typography className={classes.text}>Human Service and Emergency Providers use the login button below to access your account. If you do not have an account contact the Administrator to have an account made for you.</Typography>
